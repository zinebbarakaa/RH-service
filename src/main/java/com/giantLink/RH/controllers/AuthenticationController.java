...
public class AuthenticationController {
    ...
    public ResponseEntity<List<LoginResponse>> register(@RequestBody RegisterRequest registerRequest) {
        return new ResponseEntity<>(userService.register(registerRequest), HttpStatus.CREATED);
    }

    @PostMapping("/add-role/{userId}/{roleId}")
    public ResponseEntity<List<LoginResponse>> addRoleToUser(@PathVariable Long userId,
